...
export default function BuildQuote({
  ...
  const lppTokenTrackerLink = getLPPTokenTrackerLink(blockExplorerTokenLink);

  const blockExplorerLabel = rpcPrefs.blockExplorerUrl
    ? getURLHostName(lppTokenTrackerLink)
    : t('etherscan');
