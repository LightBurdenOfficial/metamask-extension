...
import { getLPPTokenTrackerLink, getURLHostName } from '../../../helpers/utils/util';
...
export default function TokenAsset({ token }) {
  ...
  const lppTokenTrackerLink = getLPPTokenTrackerLink(tokenTrackerLink);
            ...
            onClickBlockExplorer={() => {
              trackEvent({
                ...
                properties: {
                  ...
                  block_explorer_domain: getURLHostName(lppTokenTrackerLink),
                },
              });
              global.platform.openTab({ url: lppTokenTrackerLink });
            }}
