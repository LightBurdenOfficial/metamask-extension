...
import { getLPPTokenTrackerLink, getLBChAddressFromHex } from '../../../helpers/utils/util';
            ...
            <Button
              ...
              onClick={() => {
                const blockExplorerTokenLink = isContract
                  ? getLPPTokenTrackerLink(getTokenTrackerLink(stripHexPrefix(toAddress).toLowerCase(), chainId, null, null, {
                      blockExplorerUrl: rpcPrefs?.blockExplorerUrl ?? null,
                    }))
                  : getAccountLink(
                      getLBChAddressFromHex(toAddress, chainId),
                      chainId,
                      {
                        blockExplorerUrl: rpcPrefs?.blockExplorerUrl ?? null,
                      },
