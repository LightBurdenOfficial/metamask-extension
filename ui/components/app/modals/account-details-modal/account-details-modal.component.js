...
import { getURLHostName, getLBChAddressFromHex } from '../../../../helpers/utils/util';
...
export default class AccountDetailsModal extends Component {
  ...
  render() {
    ...
    const openBlockExplorer = () => {
      const accountLink = getAccountLink(getLBChAddressFromHex(address, chainId), chainId, rpcPrefs);
