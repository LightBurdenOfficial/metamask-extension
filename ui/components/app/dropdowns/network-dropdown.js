...
class NetworkDropdown extends Component {
  ...
  render() {
    ...
    const rpcListDetailWithoutLocalHost = rpcListDetail.filter(
      (rpc) => rpc.rpcUrl !== LOCALHOST_RPC_URL && rpc.rpcUrl !== LBCh_MAINNET_RPC_URL && rpc.rpcUrl !== LBCh_TESTNET_RPC_URL && rpc.rpcUrl !== LBCh_REGTEST_RPC_URL,
    );
    ...
    return (
      ...
      >
        ...
        {this.renderNetworkEntry('lbchMainnet')}
        {this.renderNetworkEntry('lbchTestnet')}
        {this.renderNetworkEntry('lbchRegtest')}
