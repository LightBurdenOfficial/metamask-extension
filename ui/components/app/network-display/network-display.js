...
export default function NetworkDisplay({
  ...
  let isLBCh = null;
  if (LBCh_PROVIDER_TYPES.includes(networkNickname)) {
    isLBCh = networkNickname;
    networkNickname = NETWORK_TO_NAME_MAP[networkNickname] || networkNickname;
  } else if (LBCh_PROVIDER_TYPES.includes(networkType)) {
    isLBCh = networkType || networkNickname;
