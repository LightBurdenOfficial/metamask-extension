...
import { PRIMARY, SECONDARY, ETH, LBCh } from '../helpers/constants/common';
...
export function useUserPreferencedCurrency(type, opts = {}) {
  ...
  if (
    ...
    // Display ETH
    currency = nativeCurrency || LBCh;
    numberOfDecimals = opts.numberOfDecimals || opts.ethNumberOfDecimals || 8; // LBCh: or 6?
  } else if (
    (type === SECONDARY && useNativeCurrencyAsPrimaryCurrency) ||
    (type === PRIMARY && !useNativeCurrencyAsPrimaryCurrency)
  ) {
