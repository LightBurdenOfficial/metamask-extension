...
export default function reduceMetamask(state = {}, action) {
  ...
  switch (action.type) {
    ...
    case actionConstants.UPDATE_LBCh_BALANCE: {
      return {
        ...metamaskState,
        ...action.value,
      };
...
export function getLBChBalances(state) {
  return state.metamask.lbchBalances;
}

export function getLBChAddress(state, address) {
  return state.metamask.lbchAddresses[address];
}

export function getLBChAddressBook(state) {
  return state.metamask.lbchAddresses;
}

export function isLBChAddressShow(state) {
  return state.metamask.preferences.isLBChAddressShow;
}
