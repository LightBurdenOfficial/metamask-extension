...
export const LBCh_MAINNET = 'lbchMainnet';
export const LBCh_TESTNET = 'lbchTestnet';
export const LBCh_REGTEST = 'lbchRegtest';
...
export const LBCh_MAINNET_NETWORK_ID = '81';
export const LBCh_TESTNET_NETWORK_ID = '8889';
export const LBCh_REGTEST_NETWORK_ID = '8890';
...
export const LBCh_MAINNET_CHAIN_ID = '0x51';
export const LBCh_MAINNET_ID = '89';
export const LBCh_TESTNET_CHAIN_ID = '0x22B9';
export const LBCh_TESTNET_ID = '8889';
export const LBCh_REGTEST_CHAIN_ID = '0x22BA';
export const LBCh_REGTEST_ID = '8890';
...
export const LBCh_MAINNET_DISPLAY_NAME = 'LBCh Mainnet';
export const LBCh_TESTNET_DISPLAY_NAME = 'LBCh Testnet';
export const LBCh_REGTEST_DISPLAY_NAME = 'LBCh Regtest';
...
export const LBCh_MAINNET_RPC_URL = `https://janus.qiswap.com/api/`;
export const LBCh_TESTNET_RPC_URL = `https://testnet-janus.qiswap.com/api/`;
export const LBCh_REGTEST_RPC_URL = `https://localhost:23889`;
...
export const LBCh_TOKEN_IMAGE_URL = './images/lbch_logo.png';
...
export const LBCh_PROVIDER_TYPES = [LBCh_MAINNET, LBCh_TESTNET, LBCh_REGTEST];
...
export const NETWORK_TYPE_TO_ID_MAP = {
  ...
  [LBCh_MAINNET]: {
    networkId: LBCh_MAINNET_NETWORK_ID,
    chainId: LBCh_MAINNET_CHAIN_ID,
    ticker: LBCh_SYMBOL,
  },
  [LBCh_TESTNET]: {
    networkId: LBCh_TESTNET_NETWORK_ID,
    chainId: LBCh_TESTNET_CHAIN_ID,
    ticker: LBCh_SYMBOL,
  },
  [LBCh_REGTEST]: {
    networkId: LBCh_REGTEST_NETWORK_ID,
...
export const NETWORK_TO_NAME_MAP = {
  ...
  [LBCh_MAINNET]: LBCh_MAINNET_DISPLAY_NAME,
  [LBCh_TESTNET]: LBCh_TESTNET_DISPLAY_NAME,
  [LBCh_REGTEST]: LBCh_REGTEST_DISPLAY_NAME,

  [LBCh_MAINNET_NETWORK_ID]: LBCh_MAINNET_DISPLAY_NAME,
  [LBCh_TESTNET_NETWORK_ID]: LBCh_TESTNET_DISPLAY_NAME,
  [LBCh_REGTEST_NETWORK_ID]: LBCh_REGTEST_DISPLAY_NAME,

  [LBCh_MAINNET_CHAIN_ID]: LBCh_MAINNET_DISPLAY_NAME,
  [LBCh_TESTNET_CHAIN_ID]: LBCh_TESTNET_DISPLAY_NAME,
  [LBCh_REGTEST_CHAIN_ID]: LBCh_REGTEST_DISPLAY_NAME,
};
...
export const CHAIN_ID_TO_RPC_URL_MAP = {
  ...
  [LBCh_MAINNET_CHAIN_ID]: LBCh_MAINNET_RPC_URL,
  [LBCh_TESTNET_CHAIN_ID]: LBCh_TESTNET_RPC_URL,
  [LBCh_REGTEST_CHAIN_ID]: LBCh_REGTEST_RPC_URL,
};
...
export const CHAIN_ID_TO_NETWORK_IMAGE_URL_MAP = {
  ...
  [LBCh_MAINNET_CHAIN_ID]: LBCh_TOKEN_IMAGE_URL,
};
...
export const NETWORK_ID_TO_ETHERS_NETWORK_NAME_MAP = {
  ...
  [LBCh_MAINNET_ID]: LBCh_MAINNET,
  [LBCh_TESTNET_ID]: LBCh_TESTNET,
  [LBCh_REGTEST_ID]: LBCh_REGTEST,
};
...
export const NATIVE_CURRENCY_TOKEN_IMAGE_MAP = {
  ...
  [LBCh_SYMBOL]: LBCh_TOKEN_IMAGE_URL,
