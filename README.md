# Metamask with LBCh support

This is an alpha version of Metamask with LBCh support

To use Web3 in LBCh Dapps, use `window.lbch` as your Web3 provider instead of `window.ethereum`

See [Releases](https://github.com/earlgreytech/metamask-extension/releases) for tags/releases with LBCh support

See [Janus](https://github.com/lbchproject/janus) for our Web3 compatible API layer

See [lbch-ethers-wrapper](https://github.com/earlgreytech/lbch-ethers) for client-side transaction signing
