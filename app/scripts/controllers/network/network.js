...
if (process.env.IN_TEST) {
  ...
  defaultProviderConfigOpts = {
    ...
    nickname: LBCh_TESTNET,
    rpcPrefs: {
      blockExplorerUrl: "https://testnet-explorer.lightburden.net/",
    },
  };
  // defaultProviderConfigOpts = { type: NETWORK_TYPE_RPC, chainId: LBCh_REGTEST_CHAIN_ID, rpcUrl: LBCh_REGTEST_RPC_URL };
} else {
  ...
  // defaultProviderConfigOpts = { type: NETWORK_TYPE_RPC, chainId: LBCh_MAINNET_CHAIN_ID, rpcUrl: LBCh_MAINNET_RPC_URL };
}
...
export default class NetworkController extends EventEmitter {
  ...
  lookupNetwork() {
    ...
    const isInfura =
      ...
      !LBCh_PROVIDER_TYPES.includes(type);
  ...
  setRpcTarget(rpcUrl, chainId, ticker = 'LBCh', nickname = '', rpcPrefs) {
    assert.ok(
  ...
  async setProviderType(type) {
    ...
    if (LBCh_PROVIDER_TYPES.includes(type)) {
      type = NETWORK_TYPE_RPC;
